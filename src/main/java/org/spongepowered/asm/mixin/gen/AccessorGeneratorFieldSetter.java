...
public final class AccessorGeneratorFieldSetter extends AccessorGeneratorField
{
    ...
    public final MethodNode generate() {
        final int isInstanceField;
        final MethodNode method = this.createMethod((isInstanceField = (this.isInstanceField ? 1 : 0)) + this.targetType.getSize(), isInstanceField + this.targetType.getSize());
