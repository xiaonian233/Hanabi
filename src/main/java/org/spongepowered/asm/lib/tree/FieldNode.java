...
public class FieldNode extends FieldVisitor
{
    ...
    public FieldNode(final int n, final String s, final String s2, final String s3, final Object o) {
        this(n, s, s2, s3, o, (byte)0);
        if (this.getClass() != FieldNode.class) {
            throw new IllegalStateException();
        }
    }
    
    private FieldNode(final int access, final String name, final String desc, final String signature, final Object value, final byte b) {
        super();
        this.access = access;
        this.name = name;
        this.desc = desc;
    ...
    private void accept(final ClassVisitor classVisitor) {
        ...
        if ((visitField = classVisitor.visitField(this.access, this.name, this.desc, this.signature, this.value)) == null) {
            return;
        }
        ...
        for (int n3 = (this.visibleTypeAnnotations == null) ? 0 : this.visibleTypeAnnotations.size(), k = 0; k < n3; ++k) {
            ...
            (typeAnnotationNode = this.visibleTypeAnnotations.get(k)).accept(visitField.visitTypeAnnotation(typeAnnotationNode.typeRef, typeAnnotationNode.typePath, typeAnnotationNode.desc, true));
        }
        for (int n4 = (this.invisibleTypeAnnotations == null) ? 0 : this.invisibleTypeAnnotations.size(), l = 0; l < n4; ++l) {
            ...
            (typeAnnotationNode2 = this.invisibleTypeAnnotations.get(l)).accept(visitField.visitTypeAnnotation(typeAnnotationNode2.typeRef, typeAnnotationNode2.typePath, typeAnnotationNode2.desc, false));
        }
    ...
    private static boolean lIlIIlIlIll(final Object o, final Object o2) {
        return o != o2;
    }
    
    private static boolean lIlIIllIIII(final int n) {
        return n > 0;
    }
}
